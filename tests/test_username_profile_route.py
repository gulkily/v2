...
class UsernameProfileRouteCollisionTests(unittest.TestCase):
    ...
    def test_identity_profile_lists_other_users_with_same_name(self) -> None:
        ...
        self.assertIn('id="profile-key-status"', body)
        self.assertIn('id="profile-private-key-output" class="technical-textarea" rows="10" spellcheck="false" wrap="off" readonly', body)
        self.assertIn('id="profile-public-key-output" class="technical-textarea key-display" rows="8" spellcheck="false" wrap="off" readonly', body)
