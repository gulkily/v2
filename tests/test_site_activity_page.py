...
class SiteActivityPageTests(unittest.TestCase):
    ...
    def test_activity_page_renders_records_and_metadata(self) -> None:
        ...
        self.assertIn('<a data-primary-nav-link href="/activity/" aria-current="page">Activity</a>', body)
        ...
        self.assertIn('<div class="action-row link-cluster" data-primary-nav>', body)
        self.assertIn('data-primary-nav-link href="/activity/?view=all"', body)
        self.assertIn('data-primary-nav-link href="/activity/?view=content"', body)
        self.assertIn('data-primary-nav-link href="/activity/?view=moderation"', body)
        self.assertIn('data-primary-nav-link href="/activity/?view=code"', body)
    ...
    def test_activity_page_filters_content_moderation_and_code(self) -> None:
        ...
        self.assertIn('<a data-primary-nav-link href="/activity/" aria-current="page">Activity</a>', all_body)
        self.assertIn('<a data-primary-nav-link href="/activity/" aria-current="page">Activity</a>', content_body)
        self.assertIn('<a data-primary-nav-link href="/activity/" aria-current="page">Activity</a>', moderation_body)
        self.assertIn('<a data-primary-nav-link href="/activity/" aria-current="page">Activity</a>', code_body)
        ...
        self.assertIn('class="friendly-timestamp"', moderation_body)
        self.assertIn('title="March 17, 2026 · 23:00:00 UTC"', moderation_body)
    ...
    def test_activity_page_renders_pagination_links_per_view(self) -> None:
        ...
        self.assertIn('data-primary-nav-link href="/activity/?view=content&page=2"', page_one)
        ...
        self.assertIn('data-primary-nav-link href="/activity/?view=content&page=1"', page_two)
