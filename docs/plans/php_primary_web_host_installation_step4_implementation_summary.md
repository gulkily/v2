...
- Verification:
  - Reviewed the documented host requirements against the current canonical entrypoints in `forum_web/web.py`, `cgi-bin/create_thread.py`, and `cgi-bin/create_reply.py`.
