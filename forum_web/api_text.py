...
def render_api_home_text(*, post_count: int, thread_count: int, board_tags: list[str]) -> str:
    lines = [
        "FORUM-API/1",
        "Mode: mixed",
        "Available-Commands: list_index get_thread get_post get_profile get_username_claim_cta get_merge_management get_moderation_log call_llm create_thread create_reply moderate link_identity merge_request update_profile update_thread_title",
